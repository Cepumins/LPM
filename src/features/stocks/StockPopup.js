          ...
          <div className="stock-details">
            ...
            <div className="popup-actions">
              <button 
                ...
                disabled={!userId || !hasStockInInventory() || stock.sellP === "-"}
              >
              ...
              <button 
                ...
                disabled={!userId || !canBuyStock() || stock.buyP === "-"}
              >
                {orderDetails.buyP === "-" ? "No Buy Offers" : `Buy at $${stock.buyP}`}
              </button>
              <div></div>
              <button className="create-sell-order-button" onClick={() => openCreateOrderPopup('sell')} disabled={!userId || !hasStockInInventory()}>Create Sell Order</button>
